...
export function buildTaskNotesMdbaseResources(
	...
	const generator = isRecord(extension.generator) ? extension.generator : {};
	generator.managed_fields = Object.keys(properties).sort();
	...
	return {
		...
		typeDocument: [
			...
			"# Task",
			"",
			"This type definition is the canonical TaskNotes contract for this mdbase collection.",
